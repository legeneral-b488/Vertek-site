          ...
          <div className="who-medals">
            {medals.map((m, i) => (
              <div key={i} className="medal-item">
                ...
                {m.valid && <div className="medal-valid">{m.valid}</div>}
              </div>
            ))}
          </div>
        </div>
...
function ZoneMap() {
  const depts = [
    ...
    { id: '74', nom: 'Haute-Savoie',   path: 'M262.5,92.9 L253.2,98.8 L253.3,93.7 L242.5,88.0 L240.5,83.1 L243.6,81.2 L238.5,77.5 L226.3,94.0 L223.5,102.9 L212.6,102.9 L212.5,98.2 L208.2,94.8 L205.0,94.8 L204.7,98.3 L195.9,96.4 L193.4,88.8 L186.0,86.3 L185.1,74.8 L182.0,74.0 L180.7,68.1 L180.9,57.7 L182.4,54.4 L187.3,56.7 L189.9,51.5 L207.7,50.3 L220.7,40.5 L221.9,36.9 L218.4,37.9 L216.0,34.3 L221.6,23.9 L228.5,27.0 L238.7,19.5 L262.8,20.7 L260.0,25.8 L267.7,34.1 L262.6,42.9 L262.1,50.6 L270.6,52.4 L268.6,61.3 L273.7,59.5 L282.5,76.0 L274.0,84.8 L263.9,86.1 L262.5,92.9 Z', fill: '#b8ddc8', label: { x: 231.7, y: 62.9 } },
